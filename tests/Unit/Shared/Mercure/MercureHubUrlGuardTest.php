...
final class MercureHubUrlGuardTest extends TestCase
{
    ...
    public function testAllowPrivateUrlsOptInPermitsLanButNotCloudMetadata(): void
    {
        ...
        self::assertSame(MercureHubUrlGuard::RESULT_UNSAFE, $guard->classifyHttpUrl('http://100.100.100.200/latest/meta-data'));
        self::assertSame(MercureHubUrlGuard::RESULT_UNSAFE, $guard->classifyHttpUrl('http://2852039166/latest/meta-data'));
        self::assertSame(MercureHubUrlGuard::RESULT_UNSAFE, $guard->classifyHttpUrl('http://[::ffff:169.254.169.254]/latest/meta-data'));
