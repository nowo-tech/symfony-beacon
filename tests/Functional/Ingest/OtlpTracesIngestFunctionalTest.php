...
final class OtlpTracesIngestFunctionalTest extends DatabaseWebTestCase
{
    public function testUnauthorizedWithoutKey(): void
    {
        ...
        $client->request(Request::METHOD_POST, '/api/'.$project->getUuid().'/otlp/v1/traces', [], [], [
    ...
    public function testRejectsQueryAuth(): void
    {
        ...
        $client->request(
            Request::METHOD_POST,
            '/api/'.$project->getUuid().'/otlp/v1/traces?beacon_key='.$apiKey->getPublicKey().'&beacon_secret='.rawurlencode(self::TEST_API_SECRET),
            [],
            [],
            ['CONTENT_TYPE' => 'application/json'],
            '{}',
    ...
    public function testIngestsErrorSpanAndCreatesIssue(): void
    {
        ...
        $client->request(
            Request::METHOD_POST,
            '/api/'.$project->getUuid().'/otlp/v1/traces',
            [],
            [],
