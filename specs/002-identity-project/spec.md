...
**Created**: 2026-07-19  
**Status**: Completed (as-built; dashboard create modal, group-link policy, CSRF on API keys; dual public locale routes — 2026-07-21; AuthKit `unlocalized: serve` + SiteBackup setup locale — 2026-07-31)  
