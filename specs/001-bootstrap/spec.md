...
2. Given the stack is up, when I open `/en/login` (or `/login`, which redirects), then I see the brand **symfony-beacon** (AuthKit UI, not a custom SecurityController).
...
- Security + AuthKit login surface enabled
