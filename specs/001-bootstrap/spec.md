...
2. Given the stack is up, when I open `/login`, then I see the brand **symfony-beacon**.
...
2. Given an anonymous request to `/`, when it is handled, then it redirects to `/login`.
