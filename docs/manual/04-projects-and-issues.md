...
Issues, analytics, performance, releases, and settings for a project.

## Issue list

![Issue list](images/project-issues.png)

## Analytics, performance, releases
...
Copy-for-AI: [AI-EXPORT.md](../product/AI-EXPORT.md).

## Project settings

| Section | Purpose |
|---------|---------|
| General | Name and governance |
| Access | API keys, members, shares |
| Alerts | Destinations, thresholds, health |
| Data | Import / export |
| Danger | Clear or delete |
