...
| 6.56 | **Kit polish + first-run gate**: hot-reload-bundle **1.3.2**; drop PWA `install_links` fork; BP-004 / ENGINEERING-AUDIT close; AuthKit gated until SiteBackup setup; PhoneInput `_phone_input.scss` theme bridge | Beacon | `056` / `058` / `083` / `100` / `101` | **Done** (v1.23.0) |
