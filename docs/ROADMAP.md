...
| **v1.28.0** | Product UI manual (`111` / 6.63) + wiki Home; admin/alerts create modals (`112` / 6.64); worker-safe Make `WORKER_NUM=1` recreate fix; CS + coverage hardening |
| **Unreleased** | — |
...
Last updated: 2026-09-11 (v1.28.0: Phase 6.63 / `111` product UI manual + wiki Home; Phase 6.64 / `112` admin create modals).
