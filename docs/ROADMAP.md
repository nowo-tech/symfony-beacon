...
Last updated: 2026-09-12 (v1.28.2 Phase 6.65 / `113` product E2E sharding + harness; v1.28.1 create-modal helpers; v1.28.0 Phase 6.63 / `111` + 6.64 / `112`).
