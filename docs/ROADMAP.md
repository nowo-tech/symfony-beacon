...
| **v1.25.0** | Operator `app:preload-projects` (UUID-safe, transactional); Composer pins (Symfony **8.1.6**, ORM **3.7**, kits); BreadcrumbKit empty CSRF-only delete host fix; deep E2E catalog |
...
Last updated: 2026-09-10 (v1.26.0 FrankenPHP worker-safe E2E / Phase 6.60).
